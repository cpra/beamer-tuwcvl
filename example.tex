...
% subcaptions (and subfigures)
% example:
%   \begin{figure}
%   \centering
%   \subcaptionbox{A cat\label{fig:cat}}{\includegraphics{cat}}
%   \subcaptionbox{A dog\label{fig:dog}}{\includegraphics{dog}}
%   \caption{Two animals}
%   \label{fig:animals}
%   \end{figure}
% further alignment and resizing is possible by adding e.g. {fig:cat}[0.4\linewidth]{...}
...
% use e.g. \texorpdfstring{$A_4$ Symmetry}{A4 Symmetry} if you have math in titles
% \usepackage[colorlinks=false,pdfborder={0 0 0},linkbordercolor={0 0 0}]{hyperref}
